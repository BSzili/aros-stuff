...
#ifdef SHOWHEADERINFO
#include <stdio.h>
#endif
#include <bzlib.h>
#include "7zAlloc.h"
#include "PPMd/PPMdVariantH.h"
...
#endif
*/
/* XAD CHANGE - BZ2 SUPPORT */
#if defined(__amigaos4__) || defined(__AROS__)
#define IS_UNSUPPORTED_METHOD(m) ((m) != k_Copy && (m) != k_LZMA && (m) != k_BZ2 && (m) != k_PPMD)
#else
/* PPMd doesn't work on 68k yet */
#define IS_UNSUPPORTED_METHOD(m) ((m) != k_Copy && (m) != k_LZMA && (m) != k_BZ2)
#endif
